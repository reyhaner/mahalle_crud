...
use App\Http\Controllers\uzmansController;
use App\Http\Controllers\turetim_depolamaController;
use App\Http\Controllers\turetim_isletmeController;
...
Route::middleware('auth')->group(function() {
    ...
    Route::controller(PageController::class)->group(function() {
        ...
        Route::resource('usoru', usoruController::class);

        Route::resource('urunkategori', urunkategoriController::class);
        Route::resource('uzmans', uzmansController::class);
        Route::resource('turetim_depolama', turetim_depolamaController::class);
        Route::resource('turetim_isletme', turetim_isletmeController::class);
        ...
        Route::get('usorulist', 'crudDataListusoru')->name('usorulist');
        Route::get('usoru_create', 'crudFormusoru_create')->name('usoru_create');


        Route::get('urunkategorilist', 'crudDataListurunkategori')->name('urunkategorilist');
        Route::get('urunkategori_create', 'crudFormurunkategori_create')->name('urunkategori_create');

        Route::get('turetim_depolamalist', 'crudDataListturetim_depolama')->name('turetim_depolamalist');
        Route::get('turetim_depolama_create', 'crudFormturetim_depolama_create')->name('turetim_depolama_create');

        Route::get('turetim_isletmelist', 'crudDataListturetim_isletme')->name('turetim_isletmelist');
        Route::get('turetim_isletme_create', 'crudFormturetim_isletme_create')->name('turetim_isletme_create');
        ...
        Route::get('uzmanslist', 'crudDataListuzmanslist')->name('uzmanslist');
        Route::get('uzmanscreate', 'crudFormuzmanscreate')->name('uzmanscreate');
